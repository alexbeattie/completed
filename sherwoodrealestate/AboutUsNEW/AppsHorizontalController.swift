...
//    }
    override func viewDidLoad() {
        ...
        collectionView.register(AboutUsRowCell.self, forCellWithReuseIdentifier: cellId)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! AboutUsRowCell
