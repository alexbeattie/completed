...
class ToSViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    
    let cellId = "cellId"
    
    var disclaimer = [Disclaimer]()
    
//  https://sherwoodrealestate.s3.amazonaws.com/disclaimer.json
...
//        }
        ...
        collectionView.register(TosCell.self, forCellWithReuseIdentifier: cellId)
    }
...
//        return min(4, apps.count)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
       ...
       // cell.app = self.apps[indexPath.item]
        cell.dis = self.disclaimer[indexPath.item]
        return cell
    }
